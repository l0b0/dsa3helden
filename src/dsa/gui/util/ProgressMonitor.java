...
public class ProgressMonitor {
  ...
  public ProgressMonitor(Component parent, String text) {
    optionPane = new JOptionPane(text, JOptionPane.INFORMATION_MESSAGE, JOptionPane.DEFAULT_OPTION, null, new Object[] {"Abbrechen"});
    closed = false;
    canceled = false;
  ...
  private void showDialog() {
    ...
    dialog = optionPane.createDialog(frame, "Fortschritt ...");
