...
public final class ThingsFrame extends AbstractThingsFrame {

  public ThingsFrame(ThingCarrier carrier, String container) {
    super(carrier, container);

    this.setContentPane(getThingsPanel());
