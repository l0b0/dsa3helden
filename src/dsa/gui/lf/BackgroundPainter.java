...
public class BackgroundPainter extends SyntheticaPainter {
  ...
  private static Image[] createImages() {
    ...
    images[0]  = loadImage("bg");
    images[1]  = loadImage("hout-hover");
    images[2]  = loadImage("hout");
    images[3]  = loadImage("hout-vert-active");
    images[4]  = loadImage("hout-vert-hover");
    images[5]  = loadImage("hout-vert");
    images[6]  = loadImage("hout-active");
    images[7]  = loadImage("hout-hover");
    images[8]  = loadImage("hout");
    images[9]  = loadImage("arrowButtonLeft");
    images[10] = loadImage("arrowButtonRight");
    images[11] = loadImage("arrowButtonUp");
    images[12] = loadImage("arrowButtonDown");
    images[13] = loadImage("border");
    return images;
  }
