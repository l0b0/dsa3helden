...
public class DataFactoryImpl extends DataFactory {
  ...
  public Talent createNormalTalent(String arg0,
    ...
    return new NormalTalent(arg0, arg1, arg2, arg3, arg4, false);
  }
   ...
   */
  public Talent createFightingTalent(String name, int beMinus) {
   ...
   *      int)
   */
  public Talent createFightingTalent(String name, boolean projectile,
      int beMinus) {
    return new FightingTalent(name, projectile, beMinus, 1);
  }

  public Talent createFightingTalent(String name, boolean projectile,
      int beMinus, int increases) {
   ...
   */
  public Talent createSpell(String arg0, dsa.model.characters.Property arg1,
      dsa.model.characters.Property arg2, dsa.model.characters.Property arg3,
